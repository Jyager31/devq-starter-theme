...
<div class="<?php echo esc_attr($block_classes); ?>" <?php echo $block_id ? 'id="' . esc_attr($block_id) . '"' : ''; ?> <?php echo $aos_attributes; ?> data-block-category="heroes">
    ...
    <div class="container">
        <div class="herofullscreen-content">
            <?php if ($eyebrow) : ?>
                <span class="cs-topper herofullscreen-eyebrow" <?php if ($animate) echo devq_aos('fade-up', 0, $animation_duration); ?>><?php echo esc_html($eyebrow); ?></span>
            <?php endif; ?>

            <h1 class="herofullscreen-heading" <?php if ($animate) echo devq_aos('fade-up', 100, $animation_duration); ?>><?php echo esc_html($heading); ?></h1>

            <?php if ($subheading) : ?>
                <p class="herofullscreen-subheading" <?php if ($animate) echo devq_aos('fade-up', 200, $animation_duration); ?>><?php echo esc_html($subheading); ?></p>
            <?php endif; ?>

            <?php if ($primary_button || $secondary_button) : ?>
                <div class="herofullscreen-buttons" <?php if ($animate) echo devq_aos('fade-up', 300, $animation_duration); ?>>
